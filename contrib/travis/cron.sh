...
latestFakeDbmVersion=$(curl -L https://api.github.com/repos/chadrien/Fake_DBM/releases/latest | jq -r .tag_name)

latestDbmVersionsKnown=$(curl -L https://api.github.com/repos/chadrien/Fake_DBM/contents/dbm_versions.lua?ref=${latestFakeDbmVersion} | jq -r .content)
